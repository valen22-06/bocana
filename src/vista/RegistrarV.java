 ...
 * @author Usuario
 */
public class RegistrarV extends JFrame{
    public Container contenedor;
    public JLabel infor;
    public JLabel lregistrar;
    public JLabel ldocumento;
    ...
    public RegistrarV(){
        ...
        lregistrar = new JLabel("Registrar");
        ...
        migrid = new GridLayout(9, 2, 80, 8);
        panelCentro.setLayout(migrid);
        
        ldocumento = new JLabel("Numero documento");
        ldocumento.setFont(new Font("Times New Roman", 0, 30));
        ...
        tdocumento.setFont(new Font("Times New Roman", 0, 25));
